    ...
    - title: "BWAIndex"
      nested-files:
        - title: "BWAIndex_hg19.zip"
          source_url: "https://compbio.med.harvard.edu/hint/BWAIndex/BWAIndex_hg19.zip"
          src: "BWAIndex_hg19.zip"
          size: "3.2 GB"
        - title: "BWAIndex_hg38.zip"
          source_url: "https://compbio.med.harvard.edu/hint/BWAIndex/BWAIndex_hg38.zip"
          src: "BWAIndex_hg38.zip"
          size: "3.2 GB"
        - title: "BWAIndex_mm10.zip"
          source_url: "https://compbio.med.harvard.edu/hint/BWAIndex/BWAIndex_mm10.zip"
          src: "BWAIndex_mm10.zip"
          size: "2.8 GB"
    - title: "Background Matrices"
      nested-files:
        - title: "backgroundMatrices_hg19.zip"
          source_url: "https://compbio.med.harvard.edu/hint/backgroundMatrices/backgroundMatrices_hg19.zip"
          src: "backgroundMatrices_hg19.zip"
          size: "3.7 GB"
        - title: "backgroundMatrices_hg38.zip"
          source_url: "https://compbio.med.harvard.edu/hint/backgroundMatrices/backgroundMatrices_hg38.zip"
          src: "backgroundMatrices_hg38.zip"
          size: "3.8 GB"
        - title: "backgroundMatrices_mm10.zip"
          source_url: "https://compbio.med.harvard.edu/hint/backgroundMatrices/backgroundMatrices_mm10.zip"
          src: "backgroundMatrices_mm10.zip"
          size: "3.1 GB"
    - title: "ref Data"
      nested-files:
        - title: "refData_hg19.zip"
          source_url: "https://compbio.med.harvard.edu/hint/refData/refData_hg19.zip"
          src: "refData_hg19.zip"
          size: "8.9 GB"
        - title: "refData_hg38.zip"
          source_url: "https://compbio.med.harvard.edu/hint/refData/refData_hg38.zip"
          src: "refData_hg38.zip"
          size: "1.1 GB"
        - title: "refData_mm10.zip"
          source_url: "https://compbio.med.harvard.edu/hint/refData/refData_mm10.zip"
          src: "refData_mm10.zip"
          size: "840 MB"
    - title: "Test Data"
      source_url: "https://compbio.med.harvard.edu/hint/testData.zip"
      src: "testData.zip"
      size: "1.9 GB"
---